...
class Training_file:
    def __init__(self):
        ...
        # Resizable Image
        image = Image.open(r'image/train.jpg')
        ...
        # Adding TextBoxes
        user_label = Label(root, bg="black", fg="white", text="File name")
        ...
        # Adding Buttons
        rec_button = Button(root, text="Record", bd=0, bg="green", fg="white", font=("Courier",25),command = self.reco)
        rec_button.place(relx=0.4, rely=0.6, anchor=CENTER)

        play_button = Button(root, text="Play", bd=0, bg="green", fg="white", font=("Courier",25),command = self.play)
        play_button.place(relx=0.5, rely=0.6, anchor=CENTER)

        train_button = Button(root, text="Train", bd=0, bg="green", fg="white", font=("Courier",25),command = self.train)
    ...
    def reco(self):
        ...
        global v1,v2
        try:
                fname = record_data(str(v1.get()),float(v2.get()))
        except:
                fname = record_data(v1.get())
