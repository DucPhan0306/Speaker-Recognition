...
class speaker_profile:
       def __init__(self, name):
              ...
              image = Image.open('image\\profile.gif')
              ...
              photo = PhotoImage(file="profile\\avatar\\"+str(name)+".png")
              user_image = Label(root, image=photo, anchor='n')
              user_image.image = photo
              user_image.place(relx=0.4, rely=0.1, width=250,height=300)

              desc_path = "profile\\"+str(name)+".txt"
              ...
              user_description.place(relx=0.4, rely=0.7, anchor='w')
              root.mainloop()
